...
import com.example.coffee_app.databinding.FragmentRedBinding
...
class RedFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.buttonReturn30.setOnClickListener {
            findNavController().navigate(R.id.action_redFragment_to_thirdFragment)
        }
